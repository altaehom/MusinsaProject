...
class TotalRankingAccumulatorTest {
    @InjectMockKs
    private lateinit var mut: TotalRankingAccumulator
    ...
    @Test
    fun `accumulate_1_레디스 파이프라인을 이용해서, zIncrBy와 expire가 실행 된다`() {
        val value = "2"
        val key = "TOTAL::Brand"
        ...
        every { redisZSetCommands.zIncrBy(serializedKey, any(), serializedValue) }.returns(0.0)
